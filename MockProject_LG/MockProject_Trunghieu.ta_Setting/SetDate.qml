...
Item {
    ...
    Rectangle {
        ...
        Image { id: arrLeft; source: "images/back_normal.png"
            MouseArea{
                anchors.fill: parent
                onClicked: app.screenChange("SetTime.qml")
            }
        }
      ...
      //----------------- Day --------------
        ...
        Image {
            ...
            MouseArea {
                anchors.fill: parent
                onClicked: {(pathYear.currentIndex) == 99 ? pathYear.currentIndex = 0 : pathYear.currentIndex++}
            }
        }
        ...
        Image {
            ...
            MouseArea {
                anchors.fill: parent
                onClicked: {(pathYear.currentIndex) == 0 ? pathYear.currentIndex = 99 : pathYear.currentIndex--}
            }
        }
