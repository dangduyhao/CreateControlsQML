    ...
    Rectangle{
        ...
        Image{
            ...
            MouseArea{
                ...
                anchors.fill:parent
                onClicked: {
                    list_apps.contentY > list_apps.height?list_apps.contentY -=list_apps.height:list_apps.contentY =0
                }
            }
        }
        Image {
            ...
            MouseArea{
                ...
                anchors.fill: parent
                onClicked: {
                    if(list_apps.contentY<list_apps.contentHeight-2*list_apps.height) list_apps.contentY +=list_apps.height
                    else list_apps.contentY =list_apps.contentHeight-list_apps.height
                }
            }
        }
    }
        ...
        ListView{
            ...
            delegate: Rectangle{
                ...
                Image {
                    ...
                    source: if(index<=1)return "images/toggle_inactive_4.png"; else return ""
                    MouseArea{
                        id: mouse_toggle
                        anchors.fill: parent
                        onClicked:{
