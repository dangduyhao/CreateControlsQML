    ...
    Rectangle{
        ...
        Image{
            ...
            MouseArea{
                ...
                anchors.fill:parent
                onClicked: {
                    list_system.contentY > list_system.height?list_system.contentY -=list_system.height:list_system.contentY =0
                }
            }
        }
        Image {
            ...
            MouseArea{
                ...
                anchors.fill: parent
                onClicked: {
                    if(list_system.contentY<list_system.contentHeight-2*list_system.height) list_system.contentY +=list_system.height
                    else list_system.contentY =list_system.contentHeight-list_system.height
                }
            }
        }
    }
    Rectangle{
        ...
        ListView{
            ...
            delegate: Rectangle{
                height: 68
                width: parent.width
                color: mouse_button.containsMouse?"green":"transparent"
                Image {
